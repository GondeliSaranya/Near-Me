...
public class HomeActivity extends AppCompatActivity
    ...
    DatabaseReference myRef = database.getInstance().getReference("users");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acct = getLastSignedInAccount(HomeActivity.this);
        if (acct != null) {
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            myRef.child(personName+"/latitude").setValue(latitude);
            myRef.child(personName+"/longitude").setValue(longitude);
            System.out.println("added");


        } else
            info.setText("Couldn't get the location. Make sure location is enable on the device");
